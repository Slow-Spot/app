...
const styles = StyleSheet.create({
  ...
  filterChip: {
    ...
    backgroundColor: theme.colors.chip.default.background,
    borderWidth: 1,
    borderColor: theme.colors.chip.default.border,
  },
  filterChipActive: {
    backgroundColor: theme.colors.chip.selected.background,
    borderColor: theme.colors.chip.selected.border,
  },
  filterChipText: {
    fontSize: theme.typography.fontSizes.sm,
    fontWeight: theme.typography.fontWeights.medium,
    color: theme.colors.interactive.button.primary.default,
  },
  filterChipTextActive: {
    color: theme.colors.chip.selected.text,
  },
  subFilterRow: {
  ...
  levelFilterContainer: {
    ...
    borderTopWidth: 1,
    borderTopColor: theme.colors.divider.subtle,
  },
  levelFilterLabel: {
    fontSize: theme.typography.fontSizes.sm,
    fontWeight: theme.typography.fontWeights.medium,
